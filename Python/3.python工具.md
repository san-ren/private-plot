...
<div style="border: 1px solid #e1e4e8; padding: 16px; border-radius: 6px;">
  <a href="https://zhuanlan.zhihu.com/p/663735038?utm_id=0#CTZ_BASIS" target="_blank" style="text-decoration: none; color: #0366d6;">
    <h3 style="margin: 0 0 8px 0;">CTZ_BASIS</h3>
    <p style="margin: 0; color: #586069;">[Python] 虚拟环境venv、pipenv、poetry、conda、uv如何选择？</p>
    <small style="color: #6a737d;">点击访问 →</small>
  </a>
</div>
